            ...
            <div className="flex flex-col items-center justify-between min-h-screen p-16">
                ...
                </div>
                {
                    ...
                    <button 
                        ...
                        >
                        <span className="relative px-24 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">Start Post Survey</span>
                    </button>
                }
            </div>
        </div>
